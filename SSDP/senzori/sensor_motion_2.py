            ...
            self.wfile.write(b'''
{
  "id": "motion_sensor_2",
  "type": "sensor",
  "mqtt_topic": "home/door/sensor2"
}
''')

def start_http():
    print("[motion2] HTTP on 8002")
    HTTPServer(("localhost", 8002), Handler).serve_forever()
